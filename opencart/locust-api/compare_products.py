...
class CompareProductsAddToWishListScenario(HttpUser):
    ...
    class SequenceOfTasks(SequentialTaskSet):
        ...
        def choose_product_1_add_it_to_compare_list(self):
            self.product_id_1 = ParseHTMLResponseExtractProductIDs.extract_random_product_ids()[0]
            ...
            with self.client.post(f"/upload/index.php?route=product/compare/add", {"product_id": {self.product_id_1}},
        ...
        def choose_product_2_add_it_to_compare_list(self):
            ...
            with self.client.post(f"/upload/index.php?route=product/compare/add", {"product_id": {self.product_id_2}},
                                  catch_response=True) as resp8:
        ...
        def add_product_1_to_wishlist(self):
            with self.client.post(f"/upload/index.php?route=account/wishlist/add", {"product_id": {self.product_id_1}},
                                  catch_response=True) as resp12:
